    ...
    <div className="App">
      ...
      <footer className="footer-section">
        ...
        <div className="chat-box">
          <h2>AI</h2>
          <input type="text" placeholder="Landing page of" />
          <textarea placeholder="In the Style of"></textarea>
        ...
        <div className="new-section">
          ...
          <p>Discover how KortexAI can transform your business with our innovative AI solutions.</p>
          <button className="new-section-btn">Get Started</button>
        </div>
      </footer>
    </div>
  );
