        ...
        <div className="parallax-section" ref={parallaxRef}>
          <div className="parallax-content">
            <div className="ai-solutions-container">
              ...
              <div className="ai-solutions-input-container">
                <input
                  type="text"
                  placeholder="Enter your issue or question here..."
                  className="ai-solutions-input"
                />
                <button className="ai-solutions-generate-btn">Generate Solution</button>
              </div>
              <div className="ai-solutions-output">
