    ...
    <div className="App">
      ...
      <main className="main-section">
        <div className="content-container">
          ...
          <p className="main-subtitle">Empowering tomorrow with cutting-edge AI technology.</p>
        ...
        <div className="ai-pipeline-content">
          <div className="ai-pipeline-text">
            ...
            <div className="ai-pipeline-steps">
              {['Analyzing prompt...', 'Crafting solutions...', 'Review and implement!'].map((step, index) => (
                <div key={index} className={`ai-pipeline-step ${activeStep === index ? 'active' : ''}`}>
                  <span className="step-icon">{['✨', '🔧', '🚀'][index]}</span>
                  <h4>{step}</h4>
                  <p>{['KortexAI determines the subject and context of your issue.', 'Next, it generates tailored solutions based on the analysis.', 'The solution is ready – your turn to put it into action.'][index]}</p>
                </div>
              ))}
            </div>
