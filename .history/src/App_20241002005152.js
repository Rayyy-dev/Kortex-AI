      ...
      <footer className="footer-section">
        <div className="footer-links">
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><a href="#">From Figma to Dora</a></li>
              <li><a href="#">Dora AI <span className="beta-tag">BETA</span></a></li>
              <li><a href="#">Dora AI - Figma Plugin <span className="new-tag">NEW</span></a></li>
            </ul>
          </div>
          <div className="footer-column">
            <h3>Resources</h3>
        ...
        <div className="footer-bottom">
          ...
          <div className="awards">
            <span className="award-text">Golden Kitty Awards 2023</span>
          </div>
        </div>
      </footer>
