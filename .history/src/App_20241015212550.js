            ...
            <div className="ai-solution-box">
              ...
              <div className="ai-pipeline-section">
                ...
                <div className="ai-pipeline-steps">
                  {[
                    { icon: 'fa-solid fa-magnifying-glass', title: 'Analysis', description: 'KortexAI analyzes the context and parameters of your issue.' },
                    { icon: 'fa-solid fa-lightbulb', title: 'Solution Generation', description: 'Our AI crafts tailored solutions based on comprehensive analysis.' },
                    { icon: 'fa-solid fa-gears', title: 'Optimization', description: 'Solutions are refined and optimized for maximum efficiency.' },
                    { icon: 'fa-solid fa-rocket', title: 'Implementation', description: 'Seamlessly integrate the AI-generated solution into your workflow.' }
                  ].map((step, index) => (
