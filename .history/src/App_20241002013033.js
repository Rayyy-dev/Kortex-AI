      ...
      <footer className="footer-section">
        <div className="footer-content">
          <div className="footer-logo">
            <img src="/path-to-your-logo.png" alt="KortexAI" />
          </div>
          <div className="footer-links">
            <div className="footer-column">
              ...
              <ul>
                ...
                <li><a href="#">From Figma to KortexAI</a></li>
                <li><a href="#">KortexAI AI <span className="beta-tag">BETA</span></a></li>
                <li><a href="#">KortexAI AI - Figma Plugin <span className="new-tag">NEW</span></a></li>
              </ul>
            </div>
            <div className="footer-column">
              <h3>Resources</h3>
              <ul>
                ...
                <li><a href="#">Educational Discounts</a></li>
              </ul>
            </div>
            <div className="footer-column">
              <h3>Company</h3>
        ...
        <div className="footer-bottom">
          ...
          <div className="award">
            <img src="/path-to-award-icon.png" alt="Award" />
            <span>Golden Kitty Awards 2023</span>
          </div>
        </div>
      </footer>
    );
