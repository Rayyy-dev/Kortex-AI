  ...
  return (
    <div className="App">
      <header className="header">
        ...
        <nav className="nav">
          <ul>
            <li><a onClick={(e) => {e.preventDefault(); scrollToSection('features')}}>Features</a></li>
            <li><a onClick={(e) => {e.preventDefault(); scrollToSection('analytics')}}>Analytics</a></li>
            <li><a onClick={(e) => {e.preventDefault(); scrollToSection('faq')}}>FAQ</a></li>
            <li><a onClick={(e) => {e.preventDefault(); scrollToSection('ai-solutions')}}>AI Solutions</a></li>
          </ul>
        </nav>
      ...
      <section ref={mainSectionRef} className="main-section">
        <div className="content-container">
          <h1 className="main-title">AI-Powered Dashboard Generator</h1>
      ...
      <div className="partner-strip">
        <div className="partner-strip-content">
          ...
          {[
            ...
            <div key={`${partner.name}-dup-${index}`} className="partner-item">
              {partner.icon}
              <span>{partner.name}</span>
            </div>
          ))}
