        ...
        <div className="partner-strip-content">
          <div className="partners">
            <div className="partners-container">
              <span className="partner">AWS</span>
              <span className="partner">Cloudflare</span>
              <span className="partner">Google</span>
              <span className="partner">Microsoft</span>
              <span className="partner">DeepMind</span>
              <span className="partner">IBM</span>
              <span className="partner">Amazon</span>
              <span className="partner">Apple</span>
