...
function App() {
  ...
  return (
    <div className="App">
      ...
      <section className="metrics-pipeline-section">
        ...
        >
          <div className="section-header">
            ...
            <p>Real-time system analytics and performance indicators</p>
          </div>
        ...
        >
          <div className="section-header">
            <h2>AI Pipeline</h2>
            <p>Advanced processing and analysis workflow</p>
          </div>
        ...
        >
          ...
          <p>Overall performance increase this quarter</p>
          <span className="period">Q1 2024</span>
        </motion.div>
      </section>
