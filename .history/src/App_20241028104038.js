      ...
      <section className="performance-metrics">
        <div className="metrics-card">
          <div className="metrics-header">
            ...
            <p className="metrics-description">Showing AI system performance over time</p>
          </div>
              ...
              >
                <defs>
                  ...
                  <linearGradient id="colorEfficiency" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#4A47B1" stopOpacity={0.8}/>
                    <stop offset="95%" stopColor="#4A47B1" stopOpacity={0.1}/>
                  </linearGradient>
                </defs>
                <CartesianGrid 
                  strokeDasharray="3 3" 
          ...
          <div className="metrics-footer">
            <div className="metrics-trend">
              ...
              <p className="trend-period">Performance increase this month</p>
            </div>
            <div className="metrics-period">Q1 2024</div>
          </div>
        </div>
      </section>
