            ...
            <div className="faq-section">
              ...
              <div className="faq-list">
                <div className="faq-item">
                  <h3>How do I activate KortexAI?<span className="faq-toggle">+</span></h3>
                  <div className="faq-answer">
                    <p>To activate KortexAI, simply log into your account and navigate to the 'AI Systems' section. Click on the 'Activate' button next to KortexAI, and follow the on-screen instructions to set up and customize your AI experience.</p>
                  </div>
                </div>
                <div className="faq-item">
                  <h3>How is KortexAI different from other AI tools?<span className="faq-toggle">+</span></h3>
                  <div className="faq-answer">
                    <p>KortexAI stands out with its advanced neural network architecture, real-time learning capabilities, and seamless integration across multiple platforms. Our AI offers unparalleled accuracy and efficiency in data analysis, natural language processing, and predictive modeling.</p>
                  </div>
                </div>
                <div className="faq-item">
                  <h3>How much usage is included with my KortexAI plan?<span className="faq-toggle">+</span></h3>
                  <div className="faq-answer">
                    <p>Usage limits vary depending on your subscription tier. Our basic plan includes up to 100 hours of AI processing time per month, while our premium plans offer unlimited usage. Check your account dashboard for detailed information on your current plan and usage statistics.</p>
                  </div>
                </div>
                <div className="faq-item">
                  <h3>Can KortexAI generate 3D assets or site animations?<span className="faq-toggle">+</span></h3>
                  <div className="faq-answer">
                    <p>Yes, KortexAI has advanced capabilities in generating 3D assets and creating dynamic site animations. Our AI can produce high-quality 3D models, textures, and animations based on text descriptions or 2D references. For web animations, KortexAI can generate custom CSS and JavaScript code to bring your site to life.</p>
                  </div>
                </div>
              </div>
            </div>
