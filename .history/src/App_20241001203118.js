        ...
        <div className="background-section" ref={backgroundRef}>
          <div className="background-content">
            <div className="ai-solution-box">
              <h2>AI Pipeline</h2>
              <h1 className="ai-pipeline-title">Building sites, end-to-end.</h1>
              <div className="ai-pipeline-steps">
                <div className="ai-pipeline-step active">
                  <span className="step-icon">✨</span>
                  <h4>Analyzing prompt...</h4>
                  <p>Dora AI helps determine the subject and style of your site.</p>
                </div>
                <div className="ai-pipeline-step">
                  <span className="step-icon">🔧</span>
                  <h4>Crafting designs...</h4>
                  <p>Next, it helps craft original images and copy within a responsive layout.</p>
                </div>
                <div className="ai-pipeline-step">
                  <span className="step-icon">🚀</span>
                  <h4>Tweak, iterate, publish!</h4>
                  <p>The site's generated – your turn to bring out the design chops.</p>
                </div>
              </div>
              <button className="get-started-btn">Get Started →</button>
              <div className="ai-pipeline-visual">
                <div className="ai-orb"></div>
                <p className="generating-text">Generating your page... 93%</p>
              </div>
            </div>
          </div>
        </div>
