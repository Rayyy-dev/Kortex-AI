...
function App() {
  ...
  return (
    <div className="App">
      ...
      <section className="ai-solutions-section" id="ai-solutions">
        <div className="section-container">
          {/* Main Header */}
          <div className="ai-solutions-header">
            <motion.h2 
              className="ai-solutions-title"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
            >
            ...
            <motion.p 
              className="ai-solutions-subtitle"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Describe your issue and let our AI generate a solution for you!
            </motion.p>
          </div>

          {/* Main Content Grid */}
          <div className="solutions-grid">
            {/* Left Side - AI Pipeline */}
            <div className="pipeline-container" ref={aiPipelineRef}>
              <AIPipeline onComplete={() => console.log('Generation complete')} />
            </div>

            {/* Right Side - Preview & Interaction */}
